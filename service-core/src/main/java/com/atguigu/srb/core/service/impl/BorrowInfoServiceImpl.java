...
public class BorrowInfoServiceImpl extends ServiceImpl<BorrowInfoMapper, BorrowInfo> implements BorrowInfoService {
    ...
    public BigDecimal getBorrowAmount(Long userId) {
        ...
        wrapper.ge("integral_end", integral);
        IntegralGrade integralGradeConfig = integralGradeMapper.selectOne(wrapper);
        if (null == integralGradeConfig) {
    ...
    public void saveBorrowInfo(BorrowInfo borrowInfo, Long userId) {
        ...
        //百分比转成小数
        borrowInfo.setBorrowYearRate(borrowInfo.getBorrowYearRate().divide(new BigDecimal(100), 2, BigDecimal.ROUND_HALF_UP));
